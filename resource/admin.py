...
from .models import Species, DataSet, Sequence, InformationDoc
...
class InformationDocAdmin(admin.ModelAdmin):
    model = InformationDoc
...
psirna_admin_site.register(InformationDoc, InformationDocAdmin)
